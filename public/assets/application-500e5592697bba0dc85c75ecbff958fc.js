  ...
  controllers.controller("PhotoListCtrl", [
    "$scope", "$http", "$q", "$timeout", "$location", "app", function($scope, $http, $q, $timeout, $location, app) {
      ...
      $scope.myFilter = function(o) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          keyword = _ref[_i];
          if (o.tags.search(keyword) === -1) {
            return false;
          }
        }
        if ($scope.foodType !== void 0 && o.tags.search($scope.foodType.tags) === -1) {
          return false;
        }
        return true;
      };
      $scope.helloworld = function(value) {
      ...
      return $scope.setHeightMap = function(_arg) {
        var value;
        value = _arg.value;
        $scope.heightMap = {
          "height": value
